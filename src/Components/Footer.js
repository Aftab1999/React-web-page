...
import footerbackgroundimg from "../assets/footerbackground.jpg"
                ...
                <footer>
                    <Paper sx={{
                        ...
                        <Grid item md={12} sm={6} xs={12} maxWidth="100%" sx={{ display: "block", justifyContent: "center" }}>
                            ...
                            <Typography sx={{ color: "white", marginTop: "20px", fontSize: "17px", textAlign: "center", fontWeight: "bold" }}>© 2022 React | All Rights Reserved</Typography>
                        </Grid>
                    </Paper>
                </footer>
